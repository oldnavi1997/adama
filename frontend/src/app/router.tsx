    ...
    <div className="layout-wrap">
      ...
      >
        <svg viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.115.549 4.1 1.51 5.833L.057 23.215a.75.75 0 00.922.921l5.344-1.469A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.71 9.71 0 01-4.95-1.355l-.355-.211-3.671 1.01 1.019-3.584-.23-.368A9.712 9.712 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
        </svg>
      </a>
    </div>
  );
